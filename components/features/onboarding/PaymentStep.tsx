...
export default function PaymentStep({
  ...
  const handlePaymentConfirmed = () => {
    onPaymentDataChange({
      confirmed: true,
      method: 'card', // In a real app, this would come from payment form
    });
  };
    ...
    <div className="bg-white border border-gray-200 rounded-lg p-8">
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-md p-4 mb-6">
        <div className="flex justify-between items-center">
          ...
          <span className="text-sm text-gray-700">${paymentData.amount}.00</span>
        </div>
        <div className="h-px bg-gray-200 my-3" />
        <div className="flex justify-between items-center">
          <span className="text-sm font-semibold text-gray-900">Total</span>
          <span className="text-[15px] font-semibold text-gray-900">${paymentData.amount}.00 {paymentData.currency}</span>
        </div>
      </div>
